...
We add medium and small astroids in this step. We add scale to our mvp matrix to set the size as opposed to binding any more vertex arrays. 
...
static void on_realize(GtkGLArea *area) {
	...
	for(i = 0; i astroid.radius = 40.0f;
