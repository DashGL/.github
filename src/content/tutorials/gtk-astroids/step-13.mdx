...
To start we will add in a single lonely astroid, which is not able to interact with anything. 
...
static void on_realize(GtkGLArea *area) {
	...
	for(i = 0; i GLfloat astroid_vertices[] = {
		-40.0, -40.0, 0.0, 0.0, 
		-40.0,  40.0, 0.0, 1.0,
		 40.0,  40.0, 1.0, 1.0,
...
static gboolean on_idle(gpointer data) {
	...
	for(i = 0; i astroid.pos[0] += astroid.dx;
