...
With our small viewport, any amount of movement will quickly move the player sprite off the screen. When we move the player sprite outside of the viewport, we want to wrap it to the other side of the screen. 
