...
Similar to the way we drew a static bullet before attempting to animate it, we will draw a static enemy, and then add to it. 
...
static void on_realize(GtkGLArea *area) {
	...
	int i;
	for(i = 0; i GLfloat enemy_vertices[] = {
		-32.0, -32.0, 0.0, 0.0,
		-32.0,  32.0, 0.0, 1.0,
		 32.0,  32.0, 1.0, 1.0,
