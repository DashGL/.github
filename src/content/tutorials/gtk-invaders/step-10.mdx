...
Now that we can move the player left and right, we will prepare for our program to allow the player to shoot. To start we draw a stationary bullet in the middle of the screen. 
