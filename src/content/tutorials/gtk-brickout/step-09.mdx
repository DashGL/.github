...
description: When the ball hits the edge of the screen we want it to bounce to stay in the screen
pubDate: Sept. 29, 2017
heroImage: /tuts/gtk-brick/bricks_009.png
