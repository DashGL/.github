---
title: Draw a Ball
description: We turn our triangle into a circle using
pubDate: Sept. 28, 2017
heroImage: /tuts/gtk-brick/bricks_006.png
...
Next we'll change our triangle into a circle. Since we're drawing it at the origin, only a corner will appear in the bottem left of the screen. we'll position the ball in the next step. 
