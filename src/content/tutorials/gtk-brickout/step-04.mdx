...
description: We can use an pre-existing DashGL Library function to compile the shaders
pubDate: Sept. 27, 2017
heroImage: /tuts/gtk-brick/bricks_004.png
source: https://github.com/kion-dgl/DashGL-GTK-Brickout-Tutorial/tree/master/04_Shader_Program
---

In this step we continue to simply further by compiling and linking our shader program directly through DashGL. 
